...
static void s_dump (zmq::socket_t & socket)
{
    ...
    while (1) {
        ...
        std::cout << "Message received size [" << std::setfill('0') << std::setw(9) << size << "]" << std::endl;
	...
	//  Multipart detection
        ...
        if (!more){
	    std::cout << "Will not receive another part of the message, last part received" << std::endl;
            break;              //  Last message part
	} else {
	    std::cout << "Will receive another part of the message" << std::endl;
	}
    }
}
